...
var require_benchmark = __commonJS({
  "node_modules/benchmark/benchmark.js"(exports2, module2) {
    "use strict";
    (function() {
      "use strict";
      var undefined2;
...
`;
  ...
  static fileResponse(path3) {
    const contents = import_fs.default.readFileSync(path3).toString();
...
var logger = import_winston.default.createLogger({
  ...
  transports: [
    ...
    new import_winston.default.transports.File({ filename: "server.log" })
  ]
});
...
var DBStore = class {
  constructor({
    ...
    this.id = import_crypto.default.randomBytes(16).toString("hex");
    this.offset = 0;
    this.replicas = [];
    ...
    const filePath = import_path.default.join(dir, dbfilename);
    this.path = filePath;
  ...
  connectMaster() {
    ...
    socket.on("data", (data) => {
      ...
      if (!loadedFile && contents) {
        import_fs2.default.writeFileSync(file, contents);
  ...
  set(key, value, px = void 0, type = "string", id, collection = "default") {
    ...
    const item = {
      ...
      type,
      itemType: "base",
      id: id || import_crypto.default.randomUUID()
    };
...
`;
      ...
      import_fs3.default.writeFileSync(this.path, content, "utf8");
      logger_default.info(
...
var kdbPath = import_path2.default.join(config2.dir, config2.dbfilename);
